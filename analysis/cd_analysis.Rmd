...
# Step 2: Calculate difference between 'same' and 'different'
...
difference_df %>%
  ggplot(aes(x = layer, y = difference, color = model_name, group = model_name)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
    title = "Average Difference in Cosine Similarity (Same - Different)",
    x = "Layer",
...
difference_df %>%
  ...
  ggplot(aes(x = prop_binned, y = difference, color = model_name, group = model_name)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
    title = "Average Difference in Cosine Similarity (Same - Different)",
